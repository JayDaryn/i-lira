...
contract ILIRAData {
    /* Origin address */
    address public constant ORIGIN_ADDR =
        0x9A6a414D6F3497c05E3b1De90520765fA1E07c03;

    /* Flush address */
    address payable public constant FLUSH_ADDR =
    ...
    uint256 public constant HEARTS_PER_ILIRA = 10**uint256(decimals); // 1e8
    uint256 public constant ILIRA_PER_BTC = 1e4;
    uint256 public constant SATOSHIS_PER_BTC = 1e8;
    uint256 public constant HEARTS_PER_SATOSHI =
    ...
    uint256 public constant XF_LOBBY_ENTRY_INDEX_MASK =
        (1 << XF_LOBBY_ENTRY_INDEX_SIZE) - 1;

    /* Seed for WAAS Lobby */
    uint256 public constant WAAS_LOBBY_SEED_ILIRA = 1e9;
    uint256 public constant WAAS_LOBBY_SEED_HEARTS =
    ...
    bytes32 public constant MERKLE_TREE_ROOT =
    ...
    uint256 public constant MERKLE_LEAF_FILL_SIZE =
        256 - 160 - MERKLE_LEAF_SATOSHI_SIZE;
    uint256 public constant MERKLE_LEAF_FILL_BASE =
        (1 << MERKLE_LEAF_FILL_SIZE) - 1;
    uint256 public constant MERKLE_LEAF_FILL_MASK =
    ...
    uint256 public constant LATE_PENALTY_GRACE_DAYS =
        LATE_PENALTY_GRACE_WEEKS * 7;

    uint256 public constant LATE_PENALTY_SCALE_WEEKS = 100;
    uint256 public constant LATE_PENALTY_SCALE_DAYS =
    ...
    uint256 public constant BPB_MAX_ILIRA = 150 * 1e6;
    uint256 public constant BPB_MAX_HEARTS = BPB_MAX_ILIRA * HEARTS_PER_ILIRA;
    ...
    uint8 public constant ETH_ADDRESS_ILIRA_LEN = ETH_ADDRESS_BYTE_LEN * 2;

    uint8 public constant CLAIM_PARAM_HASH_BYTE_LEN = 12;
    uint8 public constant CLAIM_PARAM_HASH_ILIRA_LEN =
        CLAIM_PARAM_HASH_BYTE_LEN * 2;

    uint8 public constant BITCOIN_SIG_PREFIX_LEN = 24;
    bytes24 public constant BITCOIN_SIG_PREFIX_STR =
        "Bitcoin Signed Message:\n";

    bytes public constant STD_CLAIM_PREFIX_STR = "Claim_ILIRA_to_0x";
    bytes public constant OLD_CLAIM_PREFIX_STR = "Claim_BitcoinILIRA_to_0x";

    bytes16 public constant ILIRA_DIGITS = "0123456789abcdef";
...
/**
 * @dev contract of the ILIRA contract
 */
interface IILIRAGlobalsAndUtility {
    /**
...
interface IILIRAStakeableToken is IILIRAGlobalsAndUtility {
    /**
...
interface IILIRAUTXOClaimValidation is IILIRAStakeableToken {
    /**
...
interface IILIRAUTXORedeemableToken is IILIRAUTXOClaimValidation {
    /**
...
interface IILIRATransformableToken is IILIRAUTXORedeemableToken {
    /**
...
interface ILIRAInnterface is IILIRATransformableToken {}
