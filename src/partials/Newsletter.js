          ...
          <div style={{backgroundColor:'#3671E9'}} className="relative bg-gray-900 rounded py-10 px-8 md:py-16 md:px-12 shadow-2xl overflow-hidden" data-aos="zoom-y-out">
            ...
            <div className="relative flex flex-col lg:flex-row justify-between items-center">
              ...
              <div className="text-center lg:text-left lg:max-w-xl">
                ...
                <div>
                  <a className="btn rounded-full text-black bg-gray-100 hover:bg-gray-200 w-full sm:w-auto sm:mb-0" href="#0"><svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
